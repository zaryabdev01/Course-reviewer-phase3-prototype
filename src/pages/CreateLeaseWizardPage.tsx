...
const STEPS = ["Course & Customer", "Commercial Terms", "Access & Restrictions", "Review"] as const;
  ...
  if (submitted) {
    return (
      <div className="mx-auto max-w-lg py-16 text-center">
        ...
        <p className="mt-1 text-sm text-muted">{values.customerName} will receive an invitation. Deployment auto-configures once payment clears.</p>
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mt-5 flex justify-between">
        ...
        {step < STEPS.length - 1 ? (
          ...
          <Button onClick={handleSubmit(() => setSubmitted(true))}>Send lease for approval</Button>
        )}
      </div>
    </div>
  );
